...
INSERT INTO `IRC_Commands` VALUES ('login', '[login <UserName> <Password>] : Login To evo-Chat Admin Mode.  (Must Be Done In A PM)', '0');
INSERT INTO `IRC_Commands` VALUES ('logout', '[logout] : Logout Of evo-Chat Admin Mode.', '0');
...
INSERT INTO `IRC_Commands` VALUES ('reload', '[reload] : Reload evo-Chat Config Options And Security Level From DataBase.', '3');
INSERT INTO `IRC_Commands` VALUES ('restart', '[restart] : Restart evo-Chat, NOT MaNGOS World Server Itself. Forces Reconnection To IRC Server.', '3');
...
INSERT INTO `IRC_Commands` VALUES ('ticket', '[ticket <list/read/delete> <limit/name/all>] : Manage GM tickets', '3');
...
INSERT INTO `IRC_Commands` VALUES ('who', '[who] : Displays Users Currently Logged In To evo-chat.', '1');
